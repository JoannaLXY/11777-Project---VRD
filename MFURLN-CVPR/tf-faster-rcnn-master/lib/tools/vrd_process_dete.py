...
N_obj = 101
DIR = '/data/xyao/sg_dataset/'
train_file_path = DIR + 'json_dataset/annotations_train.json'
test_file_path = DIR + 'json_dataset/annotations_test.json'
file_path = [train_file_path, test_file_path]
train_image_path = DIR + 'sg_train_images/'
test_image_path = DIR + 'sg_test_images/'
...
np.savez('/data/xyao/sg_dataset/MFURLN/faster_rcnn/vrd_roidb.npz',roidb=roidb)
