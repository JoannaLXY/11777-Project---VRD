...
detected_box_path = '/data/xyao/sg_dataset/MFURLN/faster_rcnn/vrd_detected_box.npz'
save_path = '/data/xyao/sg_dataset/MFURLN/process/vrd_rela_process_roidb.npz'
