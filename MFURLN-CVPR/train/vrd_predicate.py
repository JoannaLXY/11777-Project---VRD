...
roidb_path = '/data/xyao/sg_dataset/MFURLN/process/vrd_pred_process_roidb.npz'
...
model_path = '/data/xyao/sg_dataset/MFURLN/output/pred/vrd_roid_predicate.ckpt'
test_path = '/data/xyao/sg_dataset/MFURLN/output/pred/vrd_roid_predicate.npz'
...
f1 = open('/data/xyao/sg_dataset/MFURLN/output/pred/result_for_test.txt', "a") 
f1.write('For new')
f1.write('\n') 
f1.close() 
R50_val  = R50_test = 0
...
with tf.Session(config = config) as sess:
	...
	for r in range(N_round):
		...
		f1 = open('/data/xyao/sg_dataset/MFURLN/output/pred/result_train.txt', "a")  
		f1.write(str(r))
		f1.write('\t')
		f1.write(str(t))
		f1.write('\t')
