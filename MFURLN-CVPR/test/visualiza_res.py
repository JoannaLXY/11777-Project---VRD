...
path_to_dataset = "/data/xyao/sg_dataset/"
path_to_result =  '/data/xyao/sg_dataset/MFURLN/output/mfurln_result.pkl'
output_dirs = "/data/xyao/sg_dataset/predicate_viz/"

# load ground truth
img_dir = join(path_to_dataset,"sg_test_images")
gt_imgs = glob.glob(join(img_dir, "*"))
gt_annos = json.load(open(join(path_to_dataset,"json_dataset", "annotations_test.json"), 'r'))
...
with open('/data/xyao/sg_dataset/MFURLN/output/mfurln_gt.pkl', 'wb') as f:
    pickle.dump(gts, f, protocol=pickle.HIGHEST_PROTOCOL)
    print("saved to /data/xyao/sg_dataset/MFURLN/output/mfurln_gt.pkl")
