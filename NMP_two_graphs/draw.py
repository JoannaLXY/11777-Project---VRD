...
x = ['1','2','3','4','5']
re50 = [0.8992,	0.9036,	0.9003,	0.8954,	0.8945]
re100 = [0.9625,0.9669,	0.9606,	0.9615,	0.9586]

plt.plot(x, re50, marker='o', ms = 8)
plt.plot(x,re100, marker = '^', ms = 8)
plt.xlabel('N', fontsize=15)
plt.ylabel('Performance', fontsize=15)
plt.legend(['Recall@50', 'Recall@100'], fontsize=15)
plt.show()
...
# path_to_dataset = "./dataset/vrd/sg_dataset"
# path_to_json = "./dataset/vrd/json_dataset"
# path_to_result_baseline = "./results/NMP/nmp_res_rec50_top70.pkl"
# path_to_result = "./results/MCNMP/nmp_res_rec50_top70.pkl"
#
#
# # load ground truth
