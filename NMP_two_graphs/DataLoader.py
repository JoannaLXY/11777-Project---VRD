    ...
    for i in range(N):
        ...
        for key, value in roidb_use.items():
            if isinstance(value, str):
                value = roidb_use[key]
                new_value = value.replace('/DATA5_DB8/data/yhu/VTransE/dsr_vrd_vgg_feats/', '~/NMP/VTransE/vrd_vgg_feats/')
                new_value = new_value.replace('/DATA5_DB8/data/yhu/VTransE/dataset/VRD/', '~/NMP/dataset/vrd/')
